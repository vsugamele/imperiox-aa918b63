...
Publicado commit71c6de50: main GitHub; Vercel READY dpl_BJMeQCW9vx23Ee5VvqcTZhXppNFZ; Supabase channel-ai-replyv13/openflow-executorv463 ACTIVE, verify_jwtfalse preservado. Lovable confirmou website updated e nova rota redireciona ao Canvas nativo. Verificação autenticada: 35blocos, Resposta+IA, modelo configurado, oferta não aprovada. Editado título de Conexão temporariamente no navegador; persistência confirmada por SQL e título original restaurado. Fluxo continua inativo. Nenhuma mensagem real enviada.
