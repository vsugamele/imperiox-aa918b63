...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <DashboardAlerts period={dashPeriod} projectFilter={dashProject} />
      <DashboardStats period={dashPeriod} projectFilter={dashProject} />
      <DashboardRevenue period={dashPeriod} projectFilter={dashProject} isAdmin={isAdmin} />
      <DashboardAds period={dashPeriod} projectFilter={dashProject} allProjects={allProjects} />
      <DashboardCharts period={dashPeriod} projectFilter={dashProject} />
      <DashboardCards period={dashPeriod} projectFilter={dashProject} isAdmin={isAdmin} />
      <ActivityFeed />
      <GrowthDashboard />
    </div>
  );
