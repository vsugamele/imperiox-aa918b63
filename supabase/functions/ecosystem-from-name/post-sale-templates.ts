...
export function buildPostSaleBlueprints(opts: {
  ...
  const make = (titulo: string, objetivo: string, nodes: any[]) => ({
    ...
    blueprint: {
      title: titulo,
      objetivo,
      trigger: { event: objetivo, produto: produto_nome },
      nodes,
    },
  });
  ...
  return [
    make(`✅ Aprovada — ${produto_nome}`, "compra_aprovada", [
      { id: `n_${now}_1`, type: "wa_message", title: "Boas-vindas",
        blocks: [{ id: `b1`, type: "text", content: `🎉 Parabéns pela compra de ${produto_nome}! Sua jornada começa agora.\nQualquer dúvida, é só me chamar por aqui.` }] },
      ...
      { id: `n_${now}_5`, type: "wa_message", title: "Upsell",
        blocks: [{ id: `b5`, type: "text", content: `Já que você entrou pro ${produto_nome}, abri uma vaga pra você no {{upsell_nome}} com condição especial. Quer ver?` }] },
    ...
    make(`⚠️ Recusada — ${produto_nome}`, "compra_recusada", [
      { id: `r_${now}_1`, type: "wa_message", title: "Alerta amigável",
        blocks: [{ id: `b1`, type: "text", content: `Oi! Vi que rolou um problema no pagamento de ${produto_nome}. Acontece. Quer que eu tente liberar via Pix? É mais rápido e direto.` }] },
      ...
      { id: `r_${now}_5`, type: "wa_message", title: "Downsell",
        blocks: [{ id: `b5`, type: "text", content: `Se o valor cheio tá apertado, separei uma versão entrada do ${produto_nome} pra você começar agora: {{link_downsell}}` }] },
    ]),
    ...
    make(`🛒 Abandono Checkout — ${produto_nome}`, "checkout_abandonado", [
      ...
      { id: `a_${now}_2`, type: "wa_message", title: "Lembrete leve",
        blocks: [{ id: `b2`, type: "text", content: `Oi! Vi que você começou a comprar o ${produto_nome} mas não finalizou. Ficou alguma dúvida?` }] },
